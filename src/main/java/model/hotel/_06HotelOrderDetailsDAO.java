...
public interface _06HotelOrderDetailsDAO {
	...
	public abstract _06HotelOrderDetailsBean update(Integer orderNo, Integer hotelNo, String hotelName, String username, 
			String bookingPerson, String phone, java.util.Date bookingDate, java.util.Date checkIn,
			java.util.Date checkOut, String roomType, Integer totalprice, String info);
