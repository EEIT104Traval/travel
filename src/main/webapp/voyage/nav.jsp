        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <c:if test="${not empty user}">
            	<c:out value="<li class='nav-item'><a href='##' class='nav-link'>Hello!</a></li>" escapeXml="false"/>
			</c:if>
			<c:if test="${empty user}">
				<c:out value="<li class='nav-item'><a href='##' class='nav-link'>login</a></li>" escapeXml="false"/>
			</c:if>
