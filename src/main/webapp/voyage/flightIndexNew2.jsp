...
<body>
	<div style="background-image: url('images/home_slider.jpg')">
	<nav
...
<!--     <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-3704px, 0px, 0px); transition: all 0s ease 0s; width: 12964px;"><div class="owl-item cloned" style="width: 1852px;"><div class="slider-item" style="background-image: url('home_slider.jpg');"> -->
<!--         <div class="overlay"></div> -->
<!--         <div class="container"> -->
<!--           <div class="row slider-text align-items-center"> -->
<!--             <div class="col-md-7 col-sm-12 ftco-animate fadeInUp ftco-animated"> -->
<!--               <h1 class="mb-3">Making the most out of your holiday</h1> -->
<!--             </div> -->
<!--           </div> -->
<!--         </div> -->
<!--       </div></div><div class="owl-item cloned" style="width: 1852px;"><div class="slider-item" style="background-image: url('images/bg_3.jpg');"> -->
<!--         <div class="overlay"></div> -->
<!--         <div class="container"> -->
<!--           <div class="row slider-text align-items-center"> -->
<!--             <div class="col-md-7 col-sm-12 ftco-animate fadeInUp ftco-animated"> -->
...
<!--           </div> -->
<!--         </div> -->
<!--       </div></div><div class="owl-item active" style="width: 1852px;"><div class="slider-item" style="background-image: url('images/bg_4.jpg');"> -->
<!--         <div class="overlay"></div> -->
<!--         <div class="container"> -->
<!--           <div class="row slider-text align-items-center"> -->
<!--             <div class="col-md-7 col-sm-12 ftco-animate fadeInUp ftco-animated"> -->
...
<!--           </div> -->
<!--         </div> -->
<!--       </div></div><div class="owl-item" style="width: 1852px;"><div class="slider-item" style="background-image: url('images/bg_1.jpg');"> -->
<!--         <div class="overlay"></div> -->
<!--         <div class="container"> -->
<!--           <div class="row slider-text align-items-center"> -->
<!--             <div class="col-md-7 col-sm-12 ftco-animate fadeInUp ftco-animated"> -->
...
<!--           </div> -->
<!--         </div> -->
<!--       </div></div><div class="owl-item" style="width: 1852px;"><div class="slider-item" style="background-image: url('images/bg_3.jpg');"> -->
<!--         <div class="overlay"></div> -->
<!--         <div class="container"> -->
<!--           <div class="row slider-text align-items-center"> -->
<!--             <div class="col-md-7 col-sm-12 ftco-animate fadeInUp ftco-animated"> -->
...
<!--           </div> -->
<!--         </div> -->
<!--       </div></div><div class="owl-item cloned" style="width: 1852px;"><div class="slider-item" style="background-image: url('images/bg_4.jpg');"> -->
<!--         <div class="overlay"></div> -->
<!--         <div class="container"> -->
<!--           <div class="row slider-text align-items-center"> -->
<!--             <div class="col-md-7 col-sm-12 ftco-animate fadeInUp ftco-animated"> -->
...
<!--           </div> -->
<!--         </div> -->
<!--       </div></div><div class="owl-item cloned" style="width: 1852px;"><div class="slider-item" style="background-image: url('images/bg_1.jpg');"> -->
<!--         <div class="overlay"></div> -->
<!--         <div class="container"> -->
<!--           <div class="row slider-text align-items-center"> -->
<!--             <div class="col-md-7 col-sm-12 ftco-animate fadeInUp ftco-animated"> -->
				...
				<div class="col">
					<div class="home_search_container">
						...
						<div class="home_search_content"
							style="display: block; position: relative; -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box;">
					...
					<div class="media block-6 services d-block text-center">
						<div class="d-flex justify-content-center">
							<div class="icon d-flex justify-content-center mb-3">
								<span class="align-self-center flaticon-sailboat"></span>
							</div>
						</div>
