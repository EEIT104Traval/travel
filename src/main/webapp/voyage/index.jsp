      ...
      <div class="container-fluid">
        <div class="row mb-5 pb-5 no-gutters">
          ...
          <div class="col-lg-8 p-2 pl-md-5 heading-section">
            <h2 class="mb-5 p-2 pb-3 ftco-animate">熱門飯店</h2>
          ...
          <div class="carousel1 owl-carousel ftco-owl">
            <div class="item">
              <div class="blog-entry">
                <a href="blog-single.html" class="block-20" style="background-image: url('images/image_51.jpg');">
                </a>
                <div class="text p-4">
                  <div class="meta">
...
<!--                     <div><a href="#">Admin</a></div> -->
                  ...
                  <h3 class="heading"><a href="#" style="font-size: 15px">台北桃園&nbsp&nbsp<i class="fas fa-exchange-alt"></i>&nbsp&nbsp&nbsp日本東京</a></h3>
                  <p class="clearfix">
                    <a href="#" class="float-left">NT$2500</a>
            ...
            <div class="item">
              <div class="blog-entry" data-aos-delay="100">
                <a href="blog-single.html" class="block-20" style="background-image: url('images/image_61.jpg');">
                </a>
                <div class="text p-4">
                  <div class="meta">
<!--                     <div><a href="#">July 7, 2018</a></div> -->
<!--                     <div><a href="#">Admin</a></div> -->
                  ...
                  <h3 class="heading"><a href="#" style="font-size: 15px">台北桃園&nbsp&nbsp<i class="fas fa-exchange-alt"></i>&nbsp&nbsp&nbsp韓國釜山</a></h3>
                  <p class="clearfix">
                    <a href="#" class="float-left">NT$3280</a>
                    <a href="#" class="float-right meta-chat"><span class="icon-chat"></span> 3</a>
                  </p>
                </div>
              </div>
            ...
            <div class="item">
              <div class="blog-entry" data-aos-delay="200">
                <a href="blog-single.html" class="block-20" style="background-image: url('images/image_71.jpg');">
                </a>
                <div class="text p-4">
                  <div class="meta">
<!--                     <div><a href="#">July 7, 2018</a></div> -->
<!--                     <div><a href="#">Admin</a></div> -->
                  ...
                  <h3 class="heading"><a href="#" style="font-size: 15px">台北桃園&nbsp&nbsp<i class="fas fa-exchange-alt"></i>&nbsp&nbsp&nbsp美國紐約</a></h3>
                  <p class="clearfix">
                    <a href="#" class="float-left">NT$20280</a>
                    <a href="#" class="float-right meta-chat"><span class="icon-chat"></span> 3</a>
                  </p>
                </div>
              </div>
            ...
            <div class="item">
              <div class="blog-entry" data-aos-delay="200">
                <a href="blog-single.html" class="block-20" style="background-image: url('images/image_81.jpg');">
                </a>
                <div class="text p-4">
                  <div class="meta">
<!--                     <div><a href="#">July 7, 2018</a></div> -->
<!--                     <div><a href="#">Admin</a></div> -->
                  ...
                  <h3 class="heading"><a href="#" style="font-size: 15px">台北桃園&nbsp&nbsp<i class="fas fa-exchange-alt"></i>&nbsp&nbsp&nbsp法國巴黎</a></h3>
                  <p class="clearfix">
                    <a href="#" class="float-left">NT$26180</a>
                    <a href="#" class="float-right meta-chat"><span class="icon-chat"></span> 3</a>
                  </p>
                </div>
              </div>
