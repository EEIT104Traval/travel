...
<link rel="stylesheet" type="text/css" href="<c:url value='/voyage/styles/bootstrap4/bootstrap.min.css'/>">
<link rel="stylesheet" type="text/css" href="<c:url value='/voyage/plugins/font-awesome-4.7.0/css/font-awesome.min.css'/>">
<link rel="stylesheet" type="text/css" href="<c:url value='/voyage/plugins/OwlCarousel2-2.2.1/owl.carousel.css'/>">
<link rel="stylesheet" type="text/css" href="<c:url value='/voyage/plugins/OwlCarousel2-2.2.1/owl.theme.default.css'/>">
<link rel="stylesheet" type="text/css" href="<c:url value='/voyage/plugins/OwlCarousel2-2.2.1/animate.css'/>">
<link rel="stylesheet" type="text/css" href="<c:url value='/voyage/styles/responsive.css'/>">
					...
					<div class="item">
						<div class="blog-entry">
							...
							<div class="text p-4">
								...
								<p class="clearfix">
									<a href="<c:url value='#'/>" class="float-left">Read more</a>
