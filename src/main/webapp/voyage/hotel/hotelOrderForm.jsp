...
<link rel="stylesheet" href="<c:url value='/voyage/css/main_styles_sherry2.css' />">
						...
						<div class="col-md-12">
							...
							<div class="row">
								<div class="col-md-12">
									<div id="card-894316">
										<div class="card">
											<div class="card-header">
												 <a class="card-link" data-toggle="collapse" data-parent="#card-894316" href="#card-element-547039">住客資料 (入住旅客姓名必須與證件上顯示的一致)</a>
											</div>
											<div id="card-element-547039" class="collapse show">
												<div class="card-body">
													...
													<p>住客</p>
													<input type="text" placeholder="姓氏 (僅限英文)">
													<input type="text" placeholder="名字 (僅限英文)">
													<p><i class="fas fa-plus-circle"></i> 添加住客<p>
													<p>此預訂最大入住人數：2</p>
												</div>
											</div>
										</div>
										<div class="card">
											<div class="card-header">
												 <a class="card-link" data-toggle="collapse" data-parent="#card-894316" href="#card-element-706372">聯絡資訊</a>
											</div>
											<div id="card-element-706372" class="collapse show">
												<div class="card-body">
													<p>住客</p>
													<input type="text" placeholder="電子郵件"><p>我們將發送確認郵件至您的電子信箱</p>
									...
									<div class="row">
										<div class="col-md-12">
											<div id="card-501538">
												<div class="card">
													<div class="card-header">
														 <a class="card-link" data-toggle="collapse" data-parent="#card-501538" href="#card-element-174917">推廣活動</a>
													</div>
													<div id="card-element-174917" class="collapse show">
														<div class="card-body">
															<div>
																<input type="text" placeholder="優惠代碼">
																<button type="button" class="btn btn-danger" style="margin: 15px">確定</button>
															</div>
														</div>
													</div>
												</div>
												<div class="card">
													<div class="card-header">
														 <a class="collapsed card-link" data-toggle="collapse" data-parent="#card-501538" href="#card-element-585877">特別要求（選填）</a>
													</div>
													<div id="card-element-585877" class="collapse">
														<div class="card-body">
															<p>我們會將您的需求轉達給飯店，但我們無法確保飯店能夠滿足。</p>
															<p>禁菸</p>
															<p><input type="checkbox">盡量安排無煙房<p>
															<p>其他</p>
															<p><input type="checkbox">盡量高層樓<p>
									...
									<div class="row" style="margin: 15px 0px 15px 0px">
										<div class="col-md-12">
											<p class="mb-0">前往下一步即表示您已閱讀並接受 TimeToTravel.com 之 條款及條件和 隱私條款。</p>
										</div>
									</div>
							...
							<div style="margin: 15px 10px 15px 15px">
								...
								請注意：所有特殊要求均視住宿的供應情況而定，也可能收取額外費用。 請注意，酒店將通過預授權收取每晚75美元的雜費押金。
								 強制性度假費包括： 供3臺設備連接的WiFi Lobby Lounge休息室或Bridges Bar酒吧15美元的飲品 Herb N' Kitchen餐廳10美元的食品券，
								 僅限外帶食物 撥打本地和免付費電話酒店不支持未滿21周歲的客人單獨入住，部分酒店、房型存在特殊政策，請以酒店告知為準。
								如果預訂客房數超過9間，住宿方將采用不同的政策和額外補充規定 。</p>
								<p>付款方式<p>
								<p>根據預訂規則，該訂單確認後不可取消修改。 您需預付訂單全額。攜程會把您的有效信用卡資料加密後傳送酒店，由酒店提前操作扣款。<p>
							</div>
							</div>
							<a href="<c:url value='/voyage/hotel/roomTypeSearch.jsp' />" style="margin: 0px 10px 10px 0px; padding-left: 30px"><i class="fas fa-chevron-left"></i> 變更我的選擇</a>
					</div>
				</div>
						...
						<div class="col-md-12">
							<div class="row">
								<div class="col-md-12">
									...
									<div style="border-bottom: 1px dotted grey; padding-bottom:10px; margin:10px"> <!-- 分隔線  -->
									<div class="row">
										<div class="col-md-6" style="padding: 0px">
											<img alt="Bootstrap Image Preview" style="margin-left: 17px" width="90%" src="https://dimg04.c-ctrip.com/images/fd/hotel/g2/M05/31/12/Cghzf1VNFfCAID8bAAqxINPZe2w423_R_800_525_R5_D.jpg" />
										</div>
										<div class="col-md-6" style="padding-left: 8px">
											...
											<p style="margin:20px 0px 0px 3px"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i></p>
											<p style="margin:20px 0px 0px 3px">1335 Avenue of the Americas</p>
										</div>
									</div>
									</div> <!-- END 分隔線  -->
									<div class="row">
									...
									<div style="border-bottom: 1px dotted grey; padding-bottom:10px; margin:10px"></div> <!-- 分隔線  -->
									<div class="row">
										<div class="col-md-6">
											<p>天際大床房</p>
										</div>
							...
							<div class="row">
								<div class="col-md-12">
									<p>總價不包括： 每房間每晚 (TWD 100)USD 3.5 城市稅</p>
								</div>
							</div>
								<p>收據</p>
								<p>如需發票，請聯絡飯店前台</p>
