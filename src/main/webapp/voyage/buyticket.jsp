...
<!-- 	<div class="order_info" style="margin-bottom: 10px;width: 80%;margin:0px auto;"> -->
		...
		<div class="price_area">
			<div class="price_h1">
				订单金额<span style="font-size: 30px;" class="price_s1">NT$${(order.adultTicketPrice)*(order.adultTicketSellQ)}</span>
			</div>
		</div>
		<!-- E 订单金额 -->
...
<!--         </div> -->
<!-- 		姓名<input > -->
			<img alt="" style="margin-left: 80px" src=" <c:url value='/flight/xianqi/img/payimg.png'/>">
			<img alt="" style="width: 300px;display: -webkit-box;margin: auto;" src=" <c:url value='/flight/xianqi/img/1521016574335213.jpg'/>">
			<div style="    margin-left: 480px;margin-top: 15px;color: #596D87;">匯率價格來自支付寶合作銀行的當日牌價</div>

    </div>
    <form action="<c:url value='/flightPay'/>">
