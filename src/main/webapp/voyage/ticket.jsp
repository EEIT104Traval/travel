...
// ------------------------------------------------------------------------------------------------------------------------------------------------------
			...
			'<div class="blog-entry">'+
				...
				'<div class="text p-4">'+
					...
					'</p>'+
					'<div>庫存餘額僅存  '+value.adultTicketSellQ+' 張</div>'+
				'</div>'+
			'</div>'+
			'</div>'+
//動態生成彈跳功能
// ------------------------------------------------------------------------------------------------------------------------------------------------------		
			  ...
			  '<div class="modal-dialog" role="document">'+
			    '<div class="modal-content">'+
			     ...
			     '<div class="modal-body">'+
			        '你現在欲購買'+value.ticketName+'<span id="totalpiece'+value.ticketNo+'"></span>'+
			      '</div>'+
			...
			document.getElementById("country").placeholder="請輸入國家" ;
			document.getElementById("category").value="";
			document.getElementById("category").placeholder="類型 - (門票、交通、餐券)";
						});
					    }
//動態生成+-功能
// ------------------------------------------------------------------------------------------------------------------------------------------------------				
...
// ----------------------------------------------------------------------------------------------------------------------------------------------------
			function submit(ticketNo){ 		　
			    		...
			    		$("#totalpiece"+ticketNo+"").text(" "+total+"張　　　　　　　"+"共＄"+(total*$("#price"+ticketNo).text())+"元");
														}
						...
						<div class="home_search_content">
							<form action="#" class="home_search_form" id="home_search_form"
								...
								<div
									...
									<input type="text" class="search_input search_input_2" id="category"
