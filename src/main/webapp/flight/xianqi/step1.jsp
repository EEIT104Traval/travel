...
//             +'<div class="fl-time">'+Ddate+"("+Ddateweek+")"+'</div>'
            +"<input class='fl-place' name='goPlace' style='border:none;text-align: center;width:82px' readonly='value' value="+Dtime+value.AirItinerary.OriginDestinationOptions.OriginDestinationOption[0].FlightSegment[0].DepartureAirport.LocationCode+">"
...
//          +'<div class="fl-dutime"> <span>'+gotimehour+'</span>小時<span>'+gotimemin+'</span>分 </div>'
         ...
         +"<input class='fl-time' style='border:none;text-align: center;width:82px' readonly='value' name='homi2' id="+'fl-time'+value.SequenceNumber+" value="+Adate+'('+Adateweek+')'+">"
//          +'<div class="fl-time" id="fl-time'+value.SequenceNumber+'">'+Adate+'('+Adateweek+')</div>'
         +"<input class='fl-place' style='border:none;text-align: center;width:82px' readonly='value' id="+'fl-place'+value.SequenceNumber+" value="+Atime+value.AirItinerary.OriginDestinationOptions.OriginDestinationOption[0].FlightSegment[0].ArrivalAirport.LocationCode+">"
...
// 		    +'<div class="fl-time">'+Ddate2+"("+Ddateweek2+")"+'</div>'
			+"<input class='fl-place' name='goPlace2' style='border:none;text-align: center;width:82px' readonly='value' value="+Dtime2+value.AirItinerary.OriginDestinationOptions.OriginDestinationOption[1].FlightSegment[0].DepartureAirport.LocationCode+">"
...
// 		 +'<div class="fl-dutime"> <span>'+backtimehour+'</span>小時<span>'+backtimemin+'</span>分 </div>'
		 ...
		 +' </div>'
		 +'<div class=" col-xs-3 fl-timebox text-left">'
		 +"<input class='fl-time' style='border:none;text-align: center;width:82px' readonly='value' name='homi2' id="+'fl-timeoo'+value.SequenceNumber+" value="+Adate2+'('+Adateweek2+')'+">"
// 		 +'<div class="fl-time" id="fl-timeoo'+value.SequenceNumber+'">'+Adate2+"("+Adateweek2+")"+'</div>'
		 +"<input class='fl-place' style='border:none;text-align: center;width:82px' readonly='value' id="+'fl-placeoo'+value.SequenceNumber+" value="+Atime2+value.AirItinerary.OriginDestinationOptions.OriginDestinationOption[1].FlightSegment[0].ArrivalAirport.LocationCode+">"
// 		 +'<div class="fl-place" id="fl-placeoo'+value.SequenceNumber+'">'+Atime2+'<span>'+value.AirItinerary.OriginDestinationOptions.OriginDestinationOption[1].FlightSegment[0].ArrivalAirport.LocationCode+'</span></div>'
		 ...
		 +' <div class="col-xs-2 fly-info">'
		 +' <div class="fltool">'
		 +"<input class='icon_fl1' name='goAirEquipType' style='border:none;text-align: center;width=68px' value="+value.AirItinerary.OriginDestinationOptions.OriginDestinationOption[1].FlightSegment[0].Equipment[0].AirEquipType+">"
