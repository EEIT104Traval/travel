...
inCity._template = [
    '<h1>请选择城市</h1>',
    '<div class="screen">',
        '<a href="javascript:void(0)" class="shar">熱門城市</a>',
...
inCity.allCity = ['台北|taipei|tp','香港|hongkong|hk','澳門|beijing|bj','大阪|beijing|bj','東京|beijing|bj','首爾|shanghai|sh', '釜山|chongqing|cq',  '廈門|shenzhen|sz', '曼谷|guangzhou|gz', '高雄|hangzhou|hz',
    '台中|nanjing|nj', '新加坡|shuzhou|sz', '吉隆坡|tianjin|tj', '成都|chengdu|cd', '南昌|nanchang|nc', '三亚|sanya|sy','青岛|qingdao|qd',
    '厦门|xiamen|xm', '新加坡|xian|xa','吉隆坡|changsha|cs','合肥|hefei|hf','西藏|xizang|xz', '内蒙古|neimenggu|nmg', '安庆|anqing|aq', '阿泰勒|ataile|atl', '安康|ankang|ak',
